...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2019 at 07:52 AM
...
--
-- Table structure for table `oc_amazonus_listing_report`
--

CREATE TABLE `oc_amazonus_listing_report` (
...
CREATE TABLE `oc_amazonus_order` (
...
CREATE TABLE `oc_amazonus_order_product` (
...
CREATE TABLE `oc_amazonus_product` (
...
CREATE TABLE `oc_amazonus_product_error` (
...
CREATE TABLE `oc_amazonus_product_link` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_amazonus_product_search`
--

CREATE TABLE `oc_amazonus_product_search` (
  `product_id` int(11) NOT NULL,
...
CREATE TABLE `oc_amazonus_product_unshipped` (
  `order_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_amazon_listing_report`
--

CREATE TABLE `oc_amazon_listing_report` (
...
--
-- Table structure for table `oc_amazon_order`
--

CREATE TABLE `oc_amazon_order` (
  `order_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_amazon_order_product`
--

CREATE TABLE `oc_amazon_order_product` (
  `order_product_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_amazon_product`
--

CREATE TABLE `oc_amazon_product` (
  `version` int(11) NOT NULL DEFAULT '2',
  `product_id` int(11) NOT NULL,
  `category` varchar(255) NOT NULL,
  `sku` varchar(255) NOT NULL,
...
--
-- Table structure for table `oc_amazon_product_error`
--

CREATE TABLE `oc_amazon_product_error` (
  `error_id` int(11) NOT NULL,
  `sku` varchar(255) NOT NULL,
  `insertion_id` varchar(255) NOT NULL,
  `error_code` int(11) NOT NULL,
...
--
-- Table structure for table `oc_amazon_product_link`
--

CREATE TABLE `oc_amazon_product_link` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_amazon_product_search`
--

CREATE TABLE `oc_amazon_product_search` (
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_amazon_product_unshipped`
--

CREATE TABLE `oc_amazon_product_unshipped` (
  `order_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `quantity` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'Default', '', 1, '2018-03-21 14:57:50', '2018-03-21 14:57:50'),
(2, 'admin', '', 1, '2018-10-16 20:36:02', '2018-10-16 20:36:02');
...
(1, 0, 0, 'bf5e7ca8df70e401b7ca811afc', 40, 0, '[]', 1, '2018-10-16 20:32:52');
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2018-10-16 18:26:31'),
...
CREATE TABLE `oc_ebay_category` (
  `ebay_category_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_ebay_category_history`
--

CREATE TABLE `oc_ebay_category_history` (
  `ebay_category_history_id` int(11) NOT NULL,
  `CategoryID` int(11) NOT NULL,
...
--
-- Table structure for table `oc_ebay_image_import`
--
...
--
-- Table structure for table `oc_ebay_listing`
--

CREATE TABLE `oc_ebay_listing` (
  `ebay_listing_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_ebay_listing_pending`
--

CREATE TABLE `oc_ebay_listing_pending` (
  `ebay_listing_pending_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_ebay_order`
--

CREATE TABLE `oc_ebay_order` (
  `ebay_order_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_ebay_order_lock`
--

CREATE TABLE `oc_ebay_order_lock` (
  `smp_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `oc_ebay_payment_method`
--

CREATE TABLE `oc_ebay_payment_method` (
  `ebay_payment_method_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_ebay_profile`
--

CREATE TABLE `oc_ebay_profile` (
  `ebay_profile_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_ebay_setting_option`
--

CREATE TABLE `oc_ebay_setting_option` (
...
--
-- Table structure for table `oc_ebay_shipping`
--

CREATE TABLE `oc_ebay_shipping` (
  `ebay_shipping_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_ebay_shipping_location`
--

CREATE TABLE `oc_ebay_shipping_location` (
  `ebay_shipping_id` int(11) NOT NULL,
  `description` varchar(100) NOT NULL,
...
--
-- Table structure for table `oc_ebay_shipping_location_exclude`
--

CREATE TABLE `oc_ebay_shipping_location_exclude` (
...
--
-- Table structure for table `oc_ebay_stock_reserve`
--

CREATE TABLE `oc_ebay_stock_reserve` (
  `id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_ebay_template`
--

CREATE TABLE `oc_ebay_template` (
...
--
-- Table structure for table `oc_ebay_transaction`
--

CREATE TABLE `oc_ebay_transaction` (
  `ebay_transaction_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_etsy_listing`
--

CREATE TABLE `oc_etsy_listing` (
...
--
-- Table structure for table `oc_etsy_order`
--

CREATE TABLE `oc_etsy_order` (
  `etsy_order_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_etsy_order_lock`
--

CREATE TABLE `oc_etsy_order_lock` (
  `order_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `oc_etsy_setting_option`
--

CREATE TABLE `oc_etsy_setting_option` (
  `etsy_setting_option_id` int(11) NOT NULL,
  `key` varchar(100) NOT NULL,
  `last_updated` datetime NOT NULL,
  `data` text NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(34, 'openbay_product_del_after', 'admin/model/catalog/product/deleteProduct/after', 'marketplace/openbay/eventDeleteProduct', 1, 0),
(35, 'openbay_product_edit_after', 'admin/model/catalog/product/editProduct/after', 'marketplace/openbay/eventEditProduct', 1, 0),
(36, 'openbay_menu', 'admin/view/common/column_left/before', 'marketplace/openbay/eventMenu', 1, 0);
...
(42, 'captcha', 'basic'),
(43, 'captcha', 'google'),
(44, 'feed', 'google_sitemap'),
(45, 'feed', 'google_base'),
(46, 'feed', 'openbaypro'),
(47, 'module', 'filter'),
(48, 'module', 'google_hangouts'),
(49, 'module', 'html'),
...
--
-- Table structure for table `oc_fba_order`
--

CREATE TABLE `oc_fba_order` (
  `order_id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc_fba_order`
--

INSERT INTO `oc_fba_order` (`order_id`, `fba_order_fulfillment_id`, `fba_order_fulfillment_ref`, `status`, `created`) VALUES
(1, 0, '', '0', '2018-03-05 10:45:31');

-- --------------------------------------------------------

--
-- Table structure for table `oc_fba_order_fulfillment`
--

CREATE TABLE `oc_fba_order_fulfillment` (
  `fba_order_fulfillment_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `created` datetime NOT NULL,
...
(32, 'Isaac', 'latest', '{\"name\":\"Isaac\",\"limit\":\"5\",\"width\":\"200\",\"height\":\"200\",\"status\":\"1\"}');
...
('081dde2b89c238dfcb7a9a00f9', '{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"abKv9cFhww1B4X1plTB1KJIk8wtu8wpM\"}', '2018-10-15 15:49:23'),
('19f76e4218f191f3996a55cae0', '{\"language\":\"en-gb\",\"currency\":\"USD\"}', '2018-03-22 17:12:20'),
('63bb804e023dc8addcd20f9be9', '{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"dkUv7bOxyhQuNkbcu67DFKYPU0eC35hk\"}', '2018-03-21 12:56:47'),
('aa557942a79526ae4c01442be1', '{\"language\":\"en-gb\",\"currency\":\"USD\"}', '2018-10-13 19:14:38'),
('b0bcbeb1cb926e1a912cb0f9f7', '{\"language\":\"en-gb\",\"currency\":\"USD\"}', '2018-03-22 16:46:34'),
('bf5e7ca8df70e401b7ca811afc', '{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"byZDoNeKg65CohF9XlHhkATr0nUkRAOD\"}', '2018-10-16 18:54:19'),
('c8f157ca0c61e3df82a1fdfcfb', '{\"language\":\"en-gb\",\"currency\":\"USD\"}', '2018-03-22 17:12:12'),
('da3329e65e36c569b13d0d9247', '{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"wDP9BPnepT9EeUAPdPs51ccKcD8s9hUt\"}', '2018-03-22 17:12:40');
...
(369, 0, 'config', 'config_encryption', '', 0),
...
(352, 0, 'config', 'config_icon', 'catalog/glorisa.png', 0),
...
(351, 0, 'config', 'config_logo', 'catalog/glorisa.png', 0),
...
(330, 0, 'config', 'config_invoice_prefix', 'INV-2018-00', 0),
...
(305, 0, 'config', 'config_country_id', '110', 0),
(306, 0, 'config', 'config_zone_id', '1739', 0),
...
(302, 0, 'config', 'config_image', 'catalog/glorisa.png', 0),
...
(295, 0, 'config', 'config_name', 'Glorisa Online Shop', 0),
(296, 0, 'config', 'config_owner', 'Isaac Kiptanui', 0),
(297, 0, 'config', 'config_address', 'Kericho', 0),
(298, 0, 'config', 'config_geocode', '', 0),
(299, 0, 'config', 'config_email', 'isaackmaiwa@gmail.com', 0),
(300, 0, 'config', 'config_telephone', '0725696496', 0),
(291, 0, 'config', 'config_meta_description', 'Glorisa', 0),
(290, 0, 'config', 'config_meta_title', 'Glorisa Online Shop', 0),
(373, 0, 'config', 'config_error_display', '1', 0),
(374, 0, 'config', 'config_error_log', '1', 0),
(375, 0, 'config', 'config_error_filename', 'error.log', 0),
(376, 0, 'captcha_basic', 'captcha_basic_status', '1', 0),
(377, 0, 'feed_google_sitemap', 'feed_google_sitemap_status', '1', 0),
(381, 0, 'feed_openbaypro', 'feed_openbaypro_language', 'en_GB', 0),
(380, 0, 'feed_openbaypro', 'feed_openbaypro_status', '1', 0),
(382, 0, 'feed_openbaypro', 'feed_openbaypro_version', '3201', 0),
(383, 0, 'module_store', 'module_store_admin', '1', 0),
(384, 0, 'module_store', 'module_store_status', '1', 0),
(385, 0, 'fraudlabspro', 'fraud_fraudlabspro_score', '80', 0),
(386, 0, 'fraudlabspro', 'fraud_fraudlabspro_order_status_id', '17', 0),
(387, 0, 'fraudlabspro', 'fraud_fraudlabspro_review_status_id', '18', 0),
(388, 0, 'fraudlabspro', 'fraud_fraudlabspro_approve_status_id', '2', 0),
(389, 0, 'fraudlabspro', 'fraud_fraudlabspro_reject_status_id', '8', 0);
...
(1, 1, 'admin', '457be0be52c260e5b9e821ac233aabfbf250e8a0', '7G8ZfB2zg', 'John', 'Doe', 'isaackmaiwa@gmail.com', '', '', '127.0.0.1', 1, '2018-03-21 14:57:50');
...
--
-- Indexes for table `oc_amazonus_listing_report`
--
ALTER TABLE `oc_amazonus_listing_report`
  ADD PRIMARY KEY (`sku`);

--
-- Indexes for table `oc_amazonus_order`
--
ALTER TABLE `oc_amazonus_order`
  ADD PRIMARY KEY (`order_id`,`amazonus_order_id`);

--
-- Indexes for table `oc_amazonus_order_product`
--
ALTER TABLE `oc_amazonus_order_product`
  ADD PRIMARY KEY (`order_product_id`,`amazonus_order_item_id`);

--
-- Indexes for table `oc_amazonus_product`
--
ALTER TABLE `oc_amazonus_product`
  ADD PRIMARY KEY (`product_id`,`var`);

--
-- Indexes for table `oc_amazonus_product_error`
--
ALTER TABLE `oc_amazonus_product_error`
  ADD PRIMARY KEY (`error_id`);

--
-- Indexes for table `oc_amazonus_product_link`
--
ALTER TABLE `oc_amazonus_product_link`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `oc_amazonus_product_search`
--
ALTER TABLE `oc_amazonus_product_search`
  ADD PRIMARY KEY (`product_id`);

--
-- Indexes for table `oc_amazonus_product_unshipped`
--
ALTER TABLE `oc_amazonus_product_unshipped`
  ADD PRIMARY KEY (`order_id`,`product_id`);

--
-- Indexes for table `oc_amazon_listing_report`
--
ALTER TABLE `oc_amazon_listing_report`
  ADD PRIMARY KEY (`marketplace`,`sku`);

--
-- Indexes for table `oc_amazon_order`
--
ALTER TABLE `oc_amazon_order`
  ADD PRIMARY KEY (`order_id`,`amazon_order_id`);

--
-- Indexes for table `oc_amazon_order_product`
--
ALTER TABLE `oc_amazon_order_product`
  ADD PRIMARY KEY (`order_product_id`,`amazon_order_item_id`);

--
-- Indexes for table `oc_amazon_product`
--
ALTER TABLE `oc_amazon_product`
  ADD PRIMARY KEY (`product_id`,`var`);

--
-- Indexes for table `oc_amazon_product_error`
--
ALTER TABLE `oc_amazon_product_error`
  ADD PRIMARY KEY (`error_id`);

--
-- Indexes for table `oc_amazon_product_link`
--
ALTER TABLE `oc_amazon_product_link`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `oc_amazon_product_search`
--
ALTER TABLE `oc_amazon_product_search`
  ADD PRIMARY KEY (`product_id`,`marketplace`);

--
-- Indexes for table `oc_amazon_product_unshipped`
--
ALTER TABLE `oc_amazon_product_unshipped`
  ADD PRIMARY KEY (`order_id`,`product_id`);
...
ALTER TABLE `oc_ebay_category`
  ADD PRIMARY KEY (`ebay_category_id`);

--
-- Indexes for table `oc_ebay_category_history`
--
ALTER TABLE `oc_ebay_category_history`
  ADD PRIMARY KEY (`ebay_category_history_id`);

--
-- Indexes for table `oc_ebay_image_import`
--
ALTER TABLE `oc_ebay_image_import`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `oc_ebay_listing`
--
ALTER TABLE `oc_ebay_listing`
  ADD PRIMARY KEY (`ebay_listing_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `oc_ebay_listing_pending`
--
ALTER TABLE `oc_ebay_listing_pending`
  ADD PRIMARY KEY (`ebay_listing_pending_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `oc_ebay_order`
--
ALTER TABLE `oc_ebay_order`
  ADD PRIMARY KEY (`ebay_order_id`),
  ADD KEY `order_id` (`order_id`),
  ADD KEY `smp_id` (`smp_id`),
  ADD KEY `parent_ebay_order_id` (`parent_ebay_order_id`);

--
-- Indexes for table `oc_ebay_order_lock`
--
ALTER TABLE `oc_ebay_order_lock`
  ADD PRIMARY KEY (`smp_id`);

--
-- Indexes for table `oc_ebay_payment_method`
--
ALTER TABLE `oc_ebay_payment_method`
  ADD PRIMARY KEY (`ebay_payment_method_id`);

--
-- Indexes for table `oc_ebay_profile`
--
ALTER TABLE `oc_ebay_profile`
  ADD PRIMARY KEY (`ebay_profile_id`);

--
-- Indexes for table `oc_ebay_setting_option`
--
ALTER TABLE `oc_ebay_setting_option`
  ADD PRIMARY KEY (`ebay_setting_option_id`);

--
-- Indexes for table `oc_ebay_shipping`
--
ALTER TABLE `oc_ebay_shipping`
  ADD PRIMARY KEY (`ebay_shipping_id`);

--
-- Indexes for table `oc_ebay_shipping_location`
--
ALTER TABLE `oc_ebay_shipping_location`
  ADD PRIMARY KEY (`ebay_shipping_id`);

--
-- Indexes for table `oc_ebay_shipping_location_exclude`
--
ALTER TABLE `oc_ebay_shipping_location_exclude`
  ADD PRIMARY KEY (`ebay_shipping_exclude_id`);

--
-- Indexes for table `oc_ebay_stock_reserve`
--
ALTER TABLE `oc_ebay_stock_reserve`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `oc_ebay_template`
--
ALTER TABLE `oc_ebay_template`
  ADD PRIMARY KEY (`template_id`);

--
-- Indexes for table `oc_ebay_transaction`
--
ALTER TABLE `oc_ebay_transaction`
  ADD PRIMARY KEY (`ebay_transaction_id`),
  ADD KEY `product_id` (`product_id`),
  ADD KEY `order_id` (`order_id`),
  ADD KEY `smp_id` (`smp_id`);

--
-- Indexes for table `oc_etsy_listing`
--
ALTER TABLE `oc_etsy_listing`
  ADD PRIMARY KEY (`etsy_listing_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `oc_etsy_order`
--
ALTER TABLE `oc_etsy_order`
  ADD PRIMARY KEY (`etsy_order_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `oc_etsy_order_lock`
--
ALTER TABLE `oc_etsy_order_lock`
  ADD PRIMARY KEY (`order_id`);

--
-- Indexes for table `oc_etsy_setting_option`
--
ALTER TABLE `oc_etsy_setting_option`
  ADD PRIMARY KEY (`etsy_setting_option_id`);
...
--
-- Indexes for table `oc_fba_order`
--
ALTER TABLE `oc_fba_order`
  ADD KEY `fba_order_id` (`order_id`);

--
-- Indexes for table `oc_fba_order_fulfillment`
--
ALTER TABLE `oc_fba_order_fulfillment`
  ADD PRIMARY KEY (`fba_order_fulfillment_id`),
  ADD KEY `order_id` (`order_id`);
...
--
-- AUTO_INCREMENT for table `oc_amazonus_product_error`
--
ALTER TABLE `oc_amazonus_product_error`
  MODIFY `error_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_amazonus_product_link`
--
ALTER TABLE `oc_amazonus_product_link`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_amazon_product_error`
--
ALTER TABLE `oc_amazon_product_error`
  MODIFY `error_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_amazon_product_link`
--
ALTER TABLE `oc_amazon_product_link`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `oc_ebay_category`
--
ALTER TABLE `oc_ebay_category`
  MODIFY `ebay_category_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_category_history`
--
ALTER TABLE `oc_ebay_category_history`
  MODIFY `ebay_category_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_image_import`
--
ALTER TABLE `oc_ebay_image_import`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_listing`
--
ALTER TABLE `oc_ebay_listing`
  MODIFY `ebay_listing_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_listing_pending`
--
ALTER TABLE `oc_ebay_listing_pending`
  MODIFY `ebay_listing_pending_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_order`
--
ALTER TABLE `oc_ebay_order`
  MODIFY `ebay_order_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_payment_method`
--
ALTER TABLE `oc_ebay_payment_method`
  MODIFY `ebay_payment_method_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_profile`
--
ALTER TABLE `oc_ebay_profile`
  MODIFY `ebay_profile_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_setting_option`
--
ALTER TABLE `oc_ebay_setting_option`
  MODIFY `ebay_setting_option_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_shipping`
--
ALTER TABLE `oc_ebay_shipping`
  MODIFY `ebay_shipping_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_shipping_location`
--
ALTER TABLE `oc_ebay_shipping_location`
  MODIFY `ebay_shipping_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_shipping_location_exclude`
--
ALTER TABLE `oc_ebay_shipping_location_exclude`
  MODIFY `ebay_shipping_exclude_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_stock_reserve`
--
ALTER TABLE `oc_ebay_stock_reserve`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_template`
--
ALTER TABLE `oc_ebay_template`
  MODIFY `template_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_ebay_transaction`
--
ALTER TABLE `oc_ebay_transaction`
  MODIFY `ebay_transaction_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_etsy_listing`
--
ALTER TABLE `oc_etsy_listing`
  MODIFY `etsy_listing_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_etsy_order`
--
ALTER TABLE `oc_etsy_order`
  MODIFY `etsy_order_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `oc_etsy_setting_option`
--
ALTER TABLE `oc_etsy_setting_option`
  MODIFY `etsy_setting_option_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `oc_fba_order_fulfillment`
--
ALTER TABLE `oc_fba_order_fulfillment`
  MODIFY `fba_order_fulfillment_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=390;
